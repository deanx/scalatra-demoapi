  ...
  def sendMailTo(registry:Registry) = {
    ...
    val msg = new MSendMsg(
      ...
      <div style="border:1px solid black;border-radius:4px;padding:10px">
        <h4>How often do you think about to kill your developer?</h4>
        <p><a href="http://52.27.242.163:8080/vote?vote=ed&key=token"> Every day</a></p>
        <p><a href="http://52.27.242.163:8080/vote?vote=eh&key=token"> Every hour</a></p>
        <p><a href="http://52.27.242.163:8080/vote?vote=ad&key=token"> Already done!</a></p>
